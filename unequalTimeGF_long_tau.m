function [ spinUpGreenFunction, spinDnGreenFunction, output_files ] = unequalTimeGF_long_tau( t, U, tau_start, tau_end, tau_step, noOfSites, noOfUp, noOfDn, NUM_OF_EIGEN_VALUES )
